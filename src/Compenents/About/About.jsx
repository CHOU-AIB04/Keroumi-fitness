...
export const About = () => {
  return (
    ...
    <Section3 visible={false}
      tittle1 ="CARDIO" des1 = "Cardio exercise, which is sometimes referred to as aerobic exercise" svg1={Svg.svg1}
      tittle2 ="GET LEANER" des2 = "If your goal is to gain lean muscle, you should focus on exercising regularly." svg2={Svg.svg4}
