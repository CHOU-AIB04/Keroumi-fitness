...
export const Scroll = () => {
  let {storepath} = useContext(HideNav)
    ...
    <>
        {Scroll ? 
            <div className='w-10 h-10 bg-orange-500 rounded-full sh fixed bottom-10 right-10 small:right-12 flex justify-center items-center cursor-pointer z-40' onClick={scroll}>
                {
                storepath  ?  <i className="bi bi-chevron-double-up text-white font-bold"></i> : <i className="bi bi-arrow-up text-white font-bold"></i>
                }
            </div> 
            : 
            <></>
