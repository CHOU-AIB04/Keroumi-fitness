...
export const Local = () => {
  return (
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3326.3303094886437!2d-7.653383524987496!3d33.518796745710716!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xda62d6dd244cb17%3A0x28801a96349d1b60!2sKeroumi%20Fitness!5e0!3m2!1sen!2sma!4v1706776451498!5m2!1sen!2sma" 
        className='w-full h-[400px] sm:h-[650px] rounded-xl mapsh' 
    ...
    <article className="w-[350px] tablet:w-[350px] md:w-full flex flex-col items-center tablet:items-center md:items-start ">
        ...
        <nav className='grid grid-cols-1 place-items-center tablet:grid-cols-1 md:grid-cols-2 self-center'>
            <div className='flex  gap-10 l-3 relativr w-full h-[150px] items-center'>
                <div>
            ...
            <div className='flex  gap-10 w-full h-[150px] items-center'>
                <div>
