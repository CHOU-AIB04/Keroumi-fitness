...
const StoreFooter = () => {
  ...
  return (
    <footer className='w-full relative top-[540px] mt-20 h-[600px] sh'>
        <section className='w-full small_tablet:h-[70%] h-auto storecolor grid grid-cols-1 tablet:grid-cols-4 small_tablet:grid-cols-2 gap-10 tablet:gap-2 place-items-center pl-2 pb-3 pt-3 small_tablet:pb-0'>
            <nav className='w-full h-full tablet:h-2/3 relative pl-9 space-y-4 flex flex-col items-center tablet:items-start border-b border-gray-400 small_tablet:border-none pb-4 small_tablet:pb-0 mr-10 small_tablet:mr-0'>
            ...
            <nav className='w-full h-full tablet:h-2/3 relative pl-9 border-b border-gray-400 small_tablet:border-none space-y-4 flex flex-col items-center tablet:items-start pb-9 small_tablet:pb-0 mr-10 small_tablet:mr-0'>
            ...
            <nav className='w-full h-full tablet:h-2/3 relative pl-5 space-y-4 flex flex-col items-center tablet:items-start border-b border-gray-400 small_tablet:border-none pb-9 small_tablet:pb-0 mr-10 small_tablet:mr-0'>
                <h1 className='text-white font-bold text-[30px]'>Contact Info</h1>
                <div className='space-y-3 flex flex-col  tablet:items-start'>
        ...
        <section className='w-full h-[30%] bg-zinc-800 flex flex-col justify-between items-center'>
            ...
            <h1 className='text-white font-bold cursor-pointer transition-all duration-500 colorchange'>CHOUAIB ELBARRAH</h1>
